...
const { login, renewToken, crearAdmin, getAdmins, deleteUser, crearAuto, deleteAuto, actualizarAuto, actualizarTyC, getTyC, actualizarUser, getForm } = require('../controllers/admin');
